                ...
                <div class="col-8">
                    <div class="card mb-4 rounded-3 shadow-sm">
                        <div class="card-header py-1">
                            <h4 class="my-0 fw-normal">Регистрация</h4>
                        </div>
                        <form>
                            <div class="mb-3">
                            ...
                            <button type="button" class="w-100 btn btn-lg btn-outline-success">Отправить</button>
                        </form>
                    </div>
                </div>
                <div class="col-15">
                    ...
                    <div style="min-height: 70px;">
                        <div class="collapse collapse-horizontal" id="collapseWidthExample1">
                            <div class="card card-body" style="width: 1000px;">
                                Все очень просто нажми кнопку "Купить" на странице товара
                            </div>
                        </div>
                    </div>
                    <p>
                    ...
                    <div style="min-height: 70px;">
                        <div class="collapse collapse-horizontal" id="collapseWidthExample3">
                            <div class="card card-body" style="width: 1000px;">
                                Гарантия "зуб даем" а зубы у нас стальные!!!!
                            </div>
                        </div>
                    </div>
                </div>
